...
async function question(req, res) {
    try {
        ...
        const questions = await Questions.create({ question, option1, option2, option3, option4 });
...
async function updatequestion(req, res) {
    try {
        const { question, option1, option2, option3, option4 } = req.body;
            ...
            const allQuize = await Questions.findByIdAndUpdate(req.params.id, { question, option1, option2, option3, option4 }, { new: true });
